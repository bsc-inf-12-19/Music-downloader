...
<body>
    <header>
        ...
        <nav>
            <ul>
                ...
                <li><a href="top_downloads_user.php"><i class="fa-solid fa-chart-line"></i> Top Downloads</a></li>
    ...
    <div class="container">
        <div class="contact-content">
            <h2>Contact Us</h2>
            <p>If you have any questions or comments, please don't hesitate to contact us at <strong>0887022949</strong> or use the form below to send us an email:</p>
